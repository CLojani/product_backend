...
import com.efuture.assignment.util.ObjectCastUtil;
...
public class JwtService{
    private static final String ISSUER = "assign";
    public static final String USERNAME = "assign@";
    public static final String encodedKey = "!assign@efuture@2024";
    ...
    public Map<String, Object> verify(String token) throws IOException, URISyntaxException{
    	...
    	if (userType.equals("user")) {
        	User user = userRepository.findByEmployeeCode(username);
